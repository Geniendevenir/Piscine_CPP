import test_printing.test_logs as test_logs
import platform
import os
import test_exec.general_test.test_exec as test_exec
import re
...
def is_sorted(output_list, to_sort):
	...
	_, checker_result = test_exec.exec_push_swap([prog_name] + to_sort, checker_path, output_list)
